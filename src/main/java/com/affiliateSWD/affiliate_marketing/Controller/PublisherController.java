...
import com.affiliateSWD.affiliate_marketing.service.PublisherService;
...
//    }
    ...
    @GetMapping("/statEarned/{accountId}")
    public Map<String, Object> getPublisherCampaignStats(@PathVariable Long accountId) {
        return publisherService.getPublisherCampaignStats(accountId);
    }
